  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-[#d51b1e]">
            Christianity Today Demo
          </h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className={`group relative w-full min-h-10 flex justify-center py-2 px-4 border border-transparent text-sm focus:ring-white bg-[#d51b1e] hover:bg-[#d51b1e] font-medium rounded-md text-white ${
